...
public class AirQualityManager extends Configured implements Tool {
	...
	public static class AirQualityMapper extends Mapper<Object, Text, Text, DoubleWritable> {
		...
		/**
		 * DIA; CO (mg/m3);NO (ug/m3);NO2 (ug/m3);O3 (ug/m3);PM10 (ug/m3);SH2 (ug/m3);PM25 (ug/m3);PST (ug/m3);SO2 (ug/m3);PROVINCIA;ESTACIÃ“N <br>
		 * 01/01/1997; 1.2; 12; 33; 63; 56; ; ; ; 19 ;Ã�VILA ;Ã�vila
		 */
		...
		/**
		 */
		public void mapSpatial(Point key, Text value, Context context) throws IOException, InterruptedException {
			final String[] values = value.toString().split(SEPARATOR);
			Point p = new Point();
			// final String date = format(values[0]);
			final String co = format(values[1]);
